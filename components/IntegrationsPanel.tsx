          ...
          <article className="rounded-2xl border border-edge bg-void/40 p-4">
            ...
            {!status.github.connected ? (
              <button
                ...
                disabled={!userId}
                className="mt-3 flex w-full items-center justify-center gap-2 rounded-lg border border-edge bg-panel py-2 text-xs font-semibold text-ink transition hover:border-cyan/50 disabled:cursor-not-allowed disabled:opacity-50"
              >
                <LogIn className="h-3.5 w-3.5" /> Connect with GitHub
              </button>
            ) : disconnectConfirm ? (
